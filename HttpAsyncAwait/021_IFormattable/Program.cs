...
namespace _021_IFormattable
{
    //У нас Цельсии, в других странах Кельвины, у нас точка (20.5), а там - запятая (20,5) и т.д
    //Очень много классов реализуют интерфейс IFormattable, так что можно переюзать их(как мы сделали с Decimal)
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //ИЛИ МОЖЕМ ЭТО СДЕЛАТЬ РУКАМИ:  temperature.ToString("F", CultureInfo.CreateSpecificCulture("en-US")));
